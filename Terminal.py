...
# candidate_answer = "The Artificial Intelligence Program is used for super-intelligent advanced computing. The AIP is meant to be run on a computer."

answer = qa_pipeline(question=question, context=candidate_answer)
print(answer)
...
def get_response(user_input):
    try:
        answer = qa_pipeline(question=user_input, context=candidate_answer)
        return f"You asked: {user_input}. The answer is: {answer}"
    except:
